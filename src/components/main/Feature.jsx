        ...
        <div 
            ...
            <div className='relative z-10 text-white p-16 text-2xl font-semibold'>
                <div className='flex justify-between my-20'>
                    <h3>Feature 1</h3>
                    <div>
                        <span>Track Me and SOS</span>
                        <p className='text-base w-80 leading-tight font-normal'>Share your live location with trusted contacts and send instant SOS alerts during emergencies.</p>
                    </div>
                </div>
